...
\label{eq:Model3OSP}
	\begin{split}
		\log(O_i) &= \beta_0 + \beta_{\text{Passive detection}}\text{\% of Zip Code SARS-CoV2+}_i,
	\end{split}
\end{equation}
without a random intercept for zip code.
...
\label{eq:Model3OSP}
	\begin{split}
		\log(O_i) &= \beta_0 + \beta_0 + \overrightarrow{\beta}_{\text{Age Group}}\overrightarrow{\text{Age Group}}_i + \beta_{\text{Sex}}\text{Sex}_i + \overrightarrow{\beta}_{\text{Race}}\overrightarrow{\text{Race}}_i\\ 
		&+ \beta_{\text{Passive detection}}\text{\% of Zip Code SARS-CoV2+}_i,
	\end{split}
\end{equation}
without a random intercept for zip code.