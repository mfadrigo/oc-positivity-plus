...
fm_results_with_ref <- rbind(
  c(1, 0.99, 1.01, 0, paste0(c("Age [ref: 0-4yrs]", rep(" ", 38)), collapse = "")),
  fit_time_gam_inter_summary1[1:12, ],
  c(1, 0.99, 1.01, 0, paste0(c("Sex [ref: Female]", rep(" ", 37)), collapse = "")),
  fit_time_gam_inter_summary1[13, ],
  c(1, 0.99, 1.01, 0, paste0(c("Race/Ethnicity [ref: White]", rep(" ", 23)), collapse = "")),
  fit_time_gam_inter_summary1[14:20, ],
  c(1, 0.99, 1.01, 0, "% with College Degree [ref: 1st Quartile]"),
  fit_time_gam_inter_summary1[21:23, ],
  c(1, 0.99, 1.01, 0, paste0(c("% with Insurance [ref: 1st Quartile]", rep(" ", 9)), collapse = "")),
  fit_time_gam_inter_summary1[24:26, ],
  c(as.character(fit_time_gam_inter_summary1[27, -5]), paste0(c("Population Density", rep(" ", 35)), collapse = ""))
)
