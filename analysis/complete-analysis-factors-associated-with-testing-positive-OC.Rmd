...
intercept <- paste0(
  round(fit_time_gam_inter_summary[1, 1], 3),
  " (",
  round(fit_time_gam_inter_summary[1, 2], 2),
  ",",
  round(fit_time_gam_inter_summary[1, 3], 2),
  ")"
)
...
fit_time_gam_inter_plot +
  ylab("Odds Ratio of testing COVID positive") +
  xlab("")
```
