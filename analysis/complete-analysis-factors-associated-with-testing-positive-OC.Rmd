...
\begin{equation}
  \label{eq:Model1}
  \begin{split}
    \log(O_i) &= \beta_0 + \overrightarrow{\beta}^{T}_{(1-12)}\overrightarrow{\text{Age Group}}_i + \overrightarrow{\beta}_{13}\text{Male}_i + \overrightarrow{\beta}_{(14-20)}\overrightarrow{\text{Race}}_i\\
...
ggplot(fm_results_with_ref, aes(x = param_names, y = odds), size = 5) +
  ...
  ggtitle("Results of SARS-CoV-2 Posivity Logistic Regression") +
  coord_flip() +
  theme(
