...
\begin{equation}
  \label{eq:Model1}
  \begin{split}
    \log(\frac{p_{ij}}{1 + p_{ij}}) &= \beta_0 + \overrightarrow{\beta}^{T}_{(1-12)}\overrightarrow{\text{Age Group}}_i + \overrightarrow{\beta}_{13}\text{Male}_i + \overrightarrow{\beta}_{(14-20)}\overrightarrow{\text{Race}}_i\\
  ...
  \end{split}
\end{equation}
with a random intercept for zip code, $b_j \sim N(0, \sigma_b^2)$.
