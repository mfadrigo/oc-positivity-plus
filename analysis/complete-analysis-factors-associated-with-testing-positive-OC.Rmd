...
parameter_names <- c(
  ...
  "POP with Bachelors [ref: Q1]   2nd Quartile", "3rd Quartile", "4th Quartile",
  "POP with Insurance [ref: Q1]   2nd Quartile ", "3rd Quartile ", "4th Quartile ",
  "Population Density"
  )
...
```{r final-model-diagnostics, eval = FALSE}
gam.check(fit_time_gam_inter)
```
...
```{r final-model-results-plot1_alt, fig.align="center", fig.cap="Model 5 regression results for linear fixed effects. This plot excludes the coefficient for median income due to the interaction between median income and time. "}
parameter_names <- c(
  "Age [ref: 0-4yrs]                                          5-9", "10-14", "15-19", "20-24", "25-29", "30-34", 
  "35-39", "40-49", "50-59", "60-69", "70-79", "80+",
  "Sex [ref: Female]                                     Male",
...
```{r final-model-results-plot, fig.align="center", fig.cap="Model 5 regression results for linear fixed effects. This plot excludes the coefficient for median income due to the interaction between median income and time.", eval=FALSE}
groups <- c(
  rep("Age [ref: 0-4]", 12), 
  "Sex [ref: Female]", 
