...
variable_counts[order_quant_vars] <- paste(round(mean(all_pcr[, quant_vars]), 2),
                                           " (",
                                           round(sd(all_pcr[, quant_vars]), 2),
                                           ")", sep = "")
...
variable_counts[order_qual_vars] <- c(variable_counts[1:15], 
                     variable_counts[22],
                     variable_counts[16:21],
                     variable_counts[23:30])
