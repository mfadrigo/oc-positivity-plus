...
if (params$refit_model_a) {
  ...
  save(fita, file = here("analysis/testing-seropositive-regression-results", "fita.Rdata"))
} else {
  load(file = here("analysis/testing-seropositive-regression-results", "fita.Rdata"))
}
```
