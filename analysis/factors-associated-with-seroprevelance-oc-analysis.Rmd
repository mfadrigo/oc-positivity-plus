...
$\overrightarrow{\beta}_{(16-20)} = (\beta_{\text{Asian}}, \beta_{\text{Black}}, \beta_{\text{Hispanic}}, \beta_{\text{PacificIslander}}, \beta_{\text{Unknown}})$  
...
\label{eq:Model0}
	\begin{split}
		\log(O_i) &= \beta_0 + \overrightarrow{\beta}_{(1-14)}\overrightarrow{\text{Age Groups}}_i + \beta_{Sex}\text{Sex}_i + \overrightarrow{\beta}_{(16-20)}\overrightarrow{\text{Race}}_i\\
...
kable(
  ...
  pack_rows("Race[note]", 12, 18, bold = FALSE) %>%
