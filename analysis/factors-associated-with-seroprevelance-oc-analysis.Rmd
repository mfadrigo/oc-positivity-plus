...
```{r bic-table}
compare_bic <- BIC(fit0, fit1, fit2, fit3) 
row.names(compare_bic) <- c("Model 0", "Model 1", "Model 2", "Model3")
...
```{r fit2-model-results-plot, fig.align="center", fig.cap="Logistic model 0 results for odds of testing sero-positive for SARS-CoV2 in Orange County. Pasific Islander adjusted odds ratio omitted due to width of confidence interval (1.05, 15.14)."}
...
```{r fit3-model-results-plot, fig.align="center", fig.cap="Logistic model 0 results for odds of testing sero-positive for SARS-CoV2 in Orange County. Pasific Islander adjusted odds ratio omitted due to width of confidence interval (1.05, 15.14)."}
...
ggplot(fm_results_with_ref, aes(x = param_names, y = odds), size = 5, color = variable_colors) +
  ...
  ggtitle("Results of SARS-CoV2 seropositivity logisitic regression (incidence only)")
```


```{r investigate-percent-pos-relationship}
