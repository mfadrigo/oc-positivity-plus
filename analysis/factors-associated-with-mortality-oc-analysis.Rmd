...
kable(compare_bic,
      ...
      format = "latex",
      caption = "Model comparison using BIC shows do real difference in modeling odds of mortality given tested positive for SARS-CoV2 in Orange County. Therefore the simpler model, Model 1, was chosen.") %>%
