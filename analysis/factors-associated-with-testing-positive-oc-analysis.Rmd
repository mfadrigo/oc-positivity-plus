...
For simplicity let  
$O_i$ be the odds of testing positive for SARS-CoV2 in Orange County.  
...
```{r bic-table}
compare_bic <- BIC(fit_time_lin, fit_time_quad, fit_time_quad_inter, fit_time_gam, fit_time_gam_inter, fit6) 
row.names(compare_bic) <- c("Model 1", "Model 2", "Model 3", "Model 4", "Model 5", "Model 6")
