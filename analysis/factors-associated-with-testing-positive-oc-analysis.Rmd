...
if (params$refit_model2) {
  ...
  toc()
  skrrrahh("drummaboy")
  # Model failed to converge with max|grad| = 0.00219462 (tol = 0.002, component 1)
  # 4602.03 sec elapsed
...
fm_results_with_ref <- rbind(
  ...
  c(as.character(fit_time_gam_inter_house_summary1[27, -5]), "House Crowding Index")
)
